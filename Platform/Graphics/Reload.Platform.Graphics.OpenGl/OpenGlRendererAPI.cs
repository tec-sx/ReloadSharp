...
namespace Reload.Platform.Graphics.OpenGl
{
    ...
    internal class OpenGlRendererAPI : RendererAPI
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenGlRendererAPI"/> class.
        /// </summary>
        /// <param name="api">The api.</param>
        public unsafe OpenGlRendererAPI(GL api)
        {
            _gl = api;
            ...
            IntPtr userparam)
        {
            ...
            string formattedMessage = string.Format(Properties.Resources.GlDebugFormat, type, id, message);
