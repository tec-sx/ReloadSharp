namespace Reload.Input
{
        ...
        IInputEventListener<MouseWheelEvent>
    {
        ...
        private readonly ReadOnlySet<Key> NoKeys = new ReadOnlySet<Key>(new HashSet<Key>());
        ...
        /// </summary>
        public IReadOnlySet<Key> PressedKeys
        {
            get
            {
        ...
        /// </summary>
        public IReadOnlySet<Key> ReleasedKeys
        {
            get
            {
                if (!HasKeyboard) return NoKeys;
        ...
        /// </summary>
        public IReadOnlySet<Key> DownKeys
        {
            get
            {
                if (!HasKeyboard) return NoKeys;
