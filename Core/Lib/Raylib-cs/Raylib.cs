...
namespace Raylib_cs
{
    ...
    public struct Vector2
    {
        ...
        public float Length()
        {
            return Raymath.Vector2Length(this);
        }
        ...
        {
            result = Raymath.Vector2DotProduct(v1, v2);
        }
        ...
        {
            return Raymath.Vector2Divide(v, div);
        }

        public static void Normalize(ref Vector2 v)
        {
            v = Raymath.Vector2Normalize(v);
        }
        ...
        {
            return new Vector2(
                Raymath.Clamp(value1.x, min.x, max.x),
                Raymath.Clamp(value1.y, min.y, max.y));
        }
    }
    ...
    public static class Raylib
    {
        ...
        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern CharInfo[] LoadFontData(string fileName, int fontSize, int[] fontChars, int charsCount, FontType type);
