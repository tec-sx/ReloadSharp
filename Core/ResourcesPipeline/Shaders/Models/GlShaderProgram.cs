namespace Core.ResourcesPipeline.Shaders.Models
{
    ...
    using System.Linq;
    using CoreSystem.ErrorHandling;
    using Utilities;
    ...
    public class GlShaderProgram : IShaderProgram
    {
        ...
        public void CompileShader(ShaderType type, string shaderName)
        {
            ...
            {
                OpenGlShaderOperationCompleted.Warning("Can't compile shader. Linking already complete.");
                return;
            }
            ...
            var shaderSource = ResourceLoader.LoadEmbeddedResourceString(shaderResourceName);
        ...
        public void AddAttribute(string attributeName)
        {
            if (_linkingIsComplete)
            {
                OpenGlShaderOperationCompleted.Warning("Can't add attribute. Linking already complete.");
                return;
            }
        ...
        public void LinkShaders()
        {
            if (_linkingIsComplete)
            {
                OpenGlShaderOperationCompleted.Warning("Can't link shaders. Linking already complete.");
                return;
            }
